...
class ReverseImageSearchDto {
  /// Returns a new [ReverseImageSearchDto] instance.
  ...
  @override
  bool operator ==(Object other) => identical(this, other) || other is ReverseImageSearchDto &&
  ...
  /// Returns a new [ReverseImageSearchDto] instance and imports its values from
  /// [value] if it's a [Map], null otherwise.
  // ignore: prefer_constructors_over_static_methods
  static ReverseImageSearchDto? fromJson(dynamic value) {
    if (value is Map) {
      final json = value.cast<String, dynamic>();

      return ReverseImageSearchDto(
  ...
  static List<ReverseImageSearchDto> listFromJson(dynamic json, {bool growable = false,}) {
    final result = <ReverseImageSearchDto>[];
    if (json is List && json.isNotEmpty) {
      for (final row in json) {
        final value = ReverseImageSearchDto.fromJson(row);
        if (value != null) {
          result.add(value);
        }
      }
  ...
  static Map<String, ReverseImageSearchDto> mapFromJson(dynamic json) {
    final map = <String, ReverseImageSearchDto>{};
    if (json is Map && json.isNotEmpty) {
      json = json.cast<String, dynamic>(); // ignore: parameter_assignments
      for (final entry in json.entries) {
        final value = ReverseImageSearchDto.fromJson(entry.value);
        if (value != null) {
          map[entry.key] = value;
        }
      }
  ...
  // maps a json object with a list of ReverseImageSearchDto-objects as value to a dart map
  static Map<String, List<ReverseImageSearchDto>> mapListFromJson(dynamic json, {bool growable = false,}) {
    final map = <String, List<ReverseImageSearchDto>>{};
    if (json is Map && json.isNotEmpty) {
      // ignore: parameter_assignments
      json = json.cast<String, dynamic>();
      for (final entry in json.entries) {
        map[entry.key] = ReverseImageSearchDto.listFromJson(entry.value, growable: growable,);
      }
    }
    return map;
  }
