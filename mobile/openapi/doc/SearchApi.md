...
[**searchImage**](SearchApi.md#searchimage) | **POST** /search/image | 
...
# **searchImage**
> SearchResponseDto searchImage(reverseImageSearchDto)
...
final api_instance = SearchApi();
final reverseImageSearchDto = ReverseImageSearchDto(); // ReverseImageSearchDto | 

try {
    final result = api_instance.searchImage(reverseImageSearchDto);
    print(result);
} catch (e) {
    print('Exception when calling SearchApi->searchImage: $e\n');
}
```
...
Name | Type | Description  | Notes
------------- | ------------- | ------------- | -------------
 **reverseImageSearchDto** | [**ReverseImageSearchDto**](ReverseImageSearchDto.md)|  | 
